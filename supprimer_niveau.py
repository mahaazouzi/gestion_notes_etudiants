...
# Form implementation generated from reading ui file 'supprimer_niveau.ui'
#
...
"background-color: rgb(211, 207, 255);")
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(_translate("Form", "<html><head/><body><p><span style=\" font-size:12pt; color:#ffffff;\">niveau d\'etude des etudiants a supprimer:</span></p></body></html>"))
