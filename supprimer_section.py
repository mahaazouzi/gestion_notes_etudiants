...
# Form implementation generated from reading ui file 'supprimer_section.ui'
#
...
"background-color: rgb(211, 207, 255);")
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(_translate("Form", "<html><head/><body><p><span style=\" font-size:12pt; color:#ffffff;\">section des etudiants a supprimer:</span></p></body></html>"))
