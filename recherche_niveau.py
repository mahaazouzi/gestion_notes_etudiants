...
# Form implementation generated from reading ui file 'recherche_niveau.ui'
#
...
"background-color: rgb(211, 207, 255);")
        ...
        self.label.setGeometry(QtCore.QRect(170, 30, 421, 81))
    ...
    def retranslateUi(self, Form):
        ...
        self.label_2.setText(_translate("Form", "<html><head/><body><p><span style=\" font-size:12pt; color:#ffffff;\">Niveau etude de l\'etudiant:</span></p></body></html>"))
        self.pushButton.setText(_translate("Form", "AFFICHER"))
        self.label.setText(_translate("Form", "<html><head/><body><p><span style=\" text-decoration: underline; color:#ffffff;\">RECHERCHE PAR NIVEAU</span></p></body></html>"))
