...
# Form implementation generated from reading ui file 'recherche_section.ui'
#
...
"background-color: rgb(211, 207, 255);")
        ...
        self.label.setGeometry(QtCore.QRect(160, 40, 551, 81))
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(_translate("Form", "<html><head/><body><p><span style=\" text-decoration: underline; color:#ffffff;\">RECHERCHE PAR SECTION</span></p></body></html>"))
